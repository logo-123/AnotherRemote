...
public:
    ...
    enum Keys {KNoKey=0x00, KBackspace=XK_BackSpace, KTab=XK_Tab, KClear=XK_Clear, KReturn=XK_Return,
               ...
               KPrintScreen=XK_3270_PrintScreen, KInsert=XK_Insert, KDelete=XK_Delete, K_0=XK_0,
    ...
    enum Keys {KNoKey=0x00, KBackspace=VK_BACK, KTab=VK_TAB, KClear=VK_CLEAR, KReturn=VK_RETURN,
               ...
               K_5=0x35, K_6=0x36, K_7=0x37, K_8=0x38, K_9=0x39, K_A=0x41, K_B=0x42, K_C=0x43,
               K_D=0x44, K_E=0x45, K_F=0x46, K_G=0x47, K_H=0x48, K_I=0x49, K_J=0x4A, K_K=0x4B,
               K_L=0x4C, K_M=0x4E, K_N=0x4D, K_O=0x4F, K_P=0x50, K_Q=0x51, K_R=0x52, K_S=0x53,
               K_T=0x54, K_U=0x55, K_V=0x56, K_W=0x57, K_X=0x58, K_Y=0x59, K_Z=0x5A, KNum_0=VK_NUMPAD0,
